...
export const currentProject: Readable<string | null> = derived(
    appState,
    ($appState) => $appState.currentProject
);
...
export const connectionStatus: Readable<string> = derived(
    appState,
    ($appState) => $appState.connectionStatus
);
