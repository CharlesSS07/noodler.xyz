            ...
            "sections": [
                {
                    ...
                    "outgoingShape": "constraints_instruction_join_text_key_features_to_list"
                }
            ],
            "container": "root",
            "selected": false
            ...
            "sections": [
                {
                    ...
                    "incomingShape": "constraints_instruction_join_text_key_features_to_list",
                    "outgoingShape": "full_prompt"
                }
            ],
            "container": "root",
...
// remove some attributes to make the nodes more reusable
promptDesign.nodes.forEach(function (node, index) {
    const newNode = {
        id: node.id,
        type: node.type,
        data: node.data,
    ...
    promptDesign.nodes[index] = newNode;
});