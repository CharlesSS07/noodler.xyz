...
describe('SummarizationFlow Integration Tests', function() {
    ...
    describe('Content Summarization', () => {
        const testContent = `Artificial Intelligence (AI) has revolutionized numerous industries and aspects of daily life. Machine learning algorithms can now process vast amounts of data to identify patterns and make predictions. Natural language processing enables computers to understand and generate human language. Computer vision allows machines to interpret and analyze visual information from the world around them. AI applications range from recommendation systems and autonomous vehicles to medical diagnosis and financial analysis. As AI technology continues to advance, it presents both exciting opportunities and important ethical considerations that society must address carefully.`;
