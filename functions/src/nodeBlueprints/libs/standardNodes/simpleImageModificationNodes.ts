...
/**
 * Creates and configures simpleImageModificationNodes nodes.
...
`;
  ...
  hsv.code =
        ...
        "if (saturation) img.color([{ apply: \"saturate\", " +
          "params: [saturation.valueOf()] }]);\n" +
        "\n" +
        "// Adjust value (0 to 100)\n" +
        "if (value) img.color([{ apply: \"brighten\", " +
